...
// Method Abu-Hadhoud
short CalculateNumberOfVacation(stDate DateFrom, stDate DateTo) {
    short CounterDays = 0;
    while (IsDate1LessThenDate2(DateFrom, DateTo)) {
...
int main()
{
   ...
   cout << "\nActucal Vacation Day is : "<< GetDifferenceInDays(DateFrom, DateTo);
   cout << "\n\nActucal Vacation Day is : "<< CalculateNumberOfVacation(DateFrom, DateTo);
