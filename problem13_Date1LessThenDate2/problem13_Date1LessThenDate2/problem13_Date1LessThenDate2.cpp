...
//Method abu-Hadhopud
bool CheckDate1LessThenDate2MethodTwo(stDate &Date1, stDate &Date2) {
...
int main()
{
    ...
    if (CheckDate1LessThenDate2(Date1, Date2)) 
         cout << "\n\nYes , Date1 is Less Than Date 2 ";
    else 
         cout << "\n\nNo , Date1 is Not Less Than Date 2 ";



    if (CheckDate1LessThenDate2MethodTwo(Date1, Date2)) 
         cout << "\n\nYes , Date1 is Less Than Date 2 ";
    else 
         cout << "\n\nNo , Date1 is Not Less Than Date 2 ";
